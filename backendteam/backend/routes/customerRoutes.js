...
const {
  getAllCustomers, getCustomerById, addCustomer, updateCustomer, deleteCustomer, loginCustomer, getCustomerStamps, getCustomerVouchers, redeemStampVoucher
...
router.post('/:id/redeem-voucher', redeemStampVoucher);
